...
public class MySurfaceView_copy extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    private Thread th;
    ...
    public MySurfaceView_copy(Context context) {
        super(context);
    ...
    public MySurfaceView_copy(Context context, AttributeSet attrs){
        super(context);
        Log.v("Himi", "MySurfaceView");
        this.setKeepScreenOn(true);
        sfh = this.getHolder();
    ...
    public MySurfaceView_copy(Context context, AttributeSet attrs, int defStyle){
        super(context);
        Log.v("Himi", "MySurfaceView");
        this.setKeepScreenOn(true);
        sfh = this.getHolder();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN ||
            ...
            if (Math.sqrt(Math.pow((RockerCircleX - (int) event.getX()), 2)
                ...
                //System.out.println(SmallRockerCircleX);
            }
